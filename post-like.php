...
function getPostLikeLink($post_id)
{
	...
	if(hasAlreadyVoted($post_id))
		echo '<span title="'.__('I like this article', 'color-theme-framework').'" class="like icon-heart alreadyvoted"></span>'."\n";
	else
		echo '<a href="#" data-post_id="'.$post_id.'">' ."\n".'<span  title="'.__('I like this article', 'color-theme-framework').'" class="like icon-heart"></span></a>'."\n";
