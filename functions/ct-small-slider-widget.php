		...
		<div id="slider-<?php echo $time_id; ?>" class="small-slider flex-main flexslider">
			...
			<?php while($slider_posts->have_posts()): $slider_posts->the_post(); ?>
				<?php if( has_post_thumbnail() ): 
					$image = wp_get_attachment_image_src(get_post_thumbnail_id(), 'blog-thumb'); ?>
					<li>
						...
						<div class="meta">
							<?php ct_get_post_meta($post->ID, $show_likes, $show_views, $show_category, $show_date, $show_author, $show_comments); ?>
						</div><!-- .meta -->
					</li>
				<?php endif; ?>
			<?php endwhile; ?>
