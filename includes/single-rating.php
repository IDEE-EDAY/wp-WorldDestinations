	...
	<div class="review-block">
		<div class="overall_score">
			<?php
				...
				echo '<span class="score_value colored-title" itemprop="rating" style="color:' . $overall_score_color .';">' . $overall_score . '</span>'; 
			?>
			...
			<ul class="score-list">
				...
				<?php if ( $summary != '' ) : ?>
					<li class="clearfix summary-review" itemprop="summary" style="background-color:<?php echo $overall_score_color; ?>;">
						<?php echo $summary; ?>
					</li>
				<?php endif; ?>
			</ul> <!-- /score-list -->
